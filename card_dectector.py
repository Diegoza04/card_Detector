...
from utils import show_img, wait_enter
from templates import build_templates_from_directory
...
def main():
    parser = argparse.ArgumentParser(description="Reconocimiento de cartas (refactorizado).")
    ...
    parser.add_argument("--camera-url", type=str, default=None, help="URL de DroidCam (ej: http://192.168.1.100:4747/video)")
